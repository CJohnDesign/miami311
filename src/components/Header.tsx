...
const Header = () => {
  ...
  return (
    <>
      <header style={{ backgroundColor: 'transparent', position: 'absolute', top: 0, left: 0}}>
        <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <button id='openDebug' style={{ color: 'white', backgroundColor: 'transparent', border: 'none', padding: '12px' }} onClick={handleOpenDebugDrawer}>
      ...
      <DebugDrawer show={showDebugDrawer} onHide={handleCloseDebugDrawer} />
    </>
  );
};
